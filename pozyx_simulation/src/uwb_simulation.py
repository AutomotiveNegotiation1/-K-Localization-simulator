...
def calculate_distance(uwb_pose):
    ...
    #add noise 
    uwb_dist=uwb_dist+np.random.normal(0, uwb_dist*0.1,1)  
...
def publish_data(all_destination_id, all_distance):
    ...
    #uwb_data_cell.stamp = rospy.Time.now() 
...
if __name__ == "__main__":
    ...
    MODELSTATE_INDEX = rospy.get_param('/pozyx_simulation/modelstate_index',3)
